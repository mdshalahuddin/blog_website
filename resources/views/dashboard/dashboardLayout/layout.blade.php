...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/assets/css/lineicons.css') }}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="{{ asset('dashboard/assets/css/materialdesignicons.min.css') }}" rel="stylesheet" type="text/css" />
  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="index.html">
          <img src="{{ asset('dashboard/assets/images/logo/logo.svg') }}" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="{{ route('add-caregory') }}"> Add Category </a>
              </li>
              <li>
      ...
      <div class="promo-box">
        <div class="promo-icon">
          <img class="mx-auto" src="{{ asset('dashboard/assets/images/logo/logo-icon-big.svg') }}" alt="Logo">
        </div>
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset('dashboard/assets/images/lead/lead-6.png') }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset('dashboard/assets/images/lead/lead-1.png') }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="header-message-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset('dashboard/assets/images/lead/lead-5.png') }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Jacob Jones</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset('dashboard/assets/images/lead/lead-3.png') }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>John Doe</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{ asset('dashboard/assets/images/lead/lead-2.png') }}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Anee Lee</h6>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="{{ asset('dashboard/assets/images/profile/profile-image.png') }}" alt="" />
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="{{ asset('dashboard/') }}assets/images/profile/profile-image.png" alt="image">
                        </div>
                        <div class="content">
